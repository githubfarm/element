...
```javascript
import Vue from 'vue';
import ElementUI from 'element-test';
import 'element-test/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-test';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'element-test';
