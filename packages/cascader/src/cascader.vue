...
<script>
import Popper from 'element-test/src/utils/vue-popper';
import Clickoutside from 'element-test/src/utils/clickoutside';
import Emitter from 'element-test/src/mixins/emitter';
import Locale from 'element-test/src/mixins/locale';
import Migrating from 'element-test/src/mixins/migrating';
import ElInput from 'element-test/packages/input';
import ElTag from 'element-test/packages/tag';
import ElScrollbar from 'element-test/packages/scrollbar';
import ElCascaderPanel from 'element-test/packages/cascader-panel';
import AriaUtils from 'element-test/src/utils/aria-utils';
import { t } from 'element-test/src/locale';
import { isEqual, isEmpty, kebabCase } from 'element-test/src/utils/util';
import { isUndefined, isFunction } from 'element-test/src/utils/types';
import { isDef } from 'element-test/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'element-test/src/utils/resize-event';
