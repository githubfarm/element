<script>
  ...
  import ElButton from 'element-test/packages/button';
  import ElButtonGroup from 'element-test/packages/button-group';
  import { generateId } from 'element-test/src/utils/util';
